...
<!-- file ini untuk memasukkan data ke tabel informations dalam database -->
      ...
      <div class="modal-content rounded-5 shadow">
        <div class="modal-body p-5 pt-0">
          <main class="form-fill">
            ...
            <form action="/informations/store" method="post">
              @csrf


              <div class="form-floating">
                <input type="text" name="name" class="form-control mb-2" id="name" placeholder="Name" required="required">
                <label for="name">Name</label>
              </div>
              <div class="form-floating">
                <select name="roomtype" class="form-control mb-2" id="roomtype" placeholder="Roomtype" required="required">
              ...
              <div class="form-floating">
                <input type="date" , name="checkin" class="form-control mb-2" id="checkin" placeholder="checkin" required="required">
                <label for="checkin">Check in</label>
              </div>
              <div class="form-floating">
                <input type="date" , name="checkout" class="form-control mb-3" id="checkout" placeholder="checkout" required="required">
